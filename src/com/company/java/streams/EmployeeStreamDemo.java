...
public class EmployeeStreamDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n");
//        // Query 3 : What is the average age of male and female employees? Print in descending order
        employeeList.stream()
...
//        // Query 5 : Get the names of all employees who have joined after 2015?
        employeeList.stream().filter(employee -> employee.getYearOfJoining() > 2015).collect(Collectors.toList()).forEach(System.out::println);
//        method5();
        System.out.println("\n");
...
//        // development department?
        System.out.println(employeeList.stream().filter(employee -> employee.getGender().equals("Male") && employee.getDepartment().equals("Product Development")).min(Comparator.comparingDouble(Employee::getAge)).get());
//        method8();
//        System.out.println("\n");
...
//        // marketing team?
        employeeList.stream().filter(employee -> employee.getDepartment().equals("Sales And Marketing"))
                .collect(Collectors.groupingBy(Employee::getGender, Collectors.counting())).forEach((x,y) -> System.out.println(x+" : "+y));
//        method10();
//        System.out.println("\n");
//        // Query 11 : What is the average salary of male and female employees?
//        method11();
        System.out.println("\n");
          employeeList.stream().collect(Collectors.groupingBy(Employee::getGender, Collectors.averagingDouble(Employee::getSalary))).forEach((x,y) -> System.out.println(x+": "+y));
